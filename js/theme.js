...
(function ($) {
      ...
      var u = navigator.userAgent,
        ...
        b = [
          !/opera|webtv/i.test(ua) && /msie\s(\d)/.test(ua)
            ...
            ? g
            : "",
          is("j2me") ? "mobile" : is("iphone") ? "iphone" : is("ipod") ? "ipod" : is("mac") ? "mac" : is("darwin") ? "mac" : is("webtv") ? "webtv" : is("win") ? "win" : is("freebsd") ? "freebsd" : is("x11") || is("linux") ? "linux" : "",
          "js",
        ];
  ...
  var $noticeTopBar = {
    ...
    init: function () {
      ...
      if (!$.cookie("massCreativeTopBarClose")) {
        self.build().events();
      } else {
    ...
    saveCookie: function () {
      ...
      $.cookie("massCreativeTopBarClose", true);
...
!(function (t, e) {
  ...
  function ab(t, e, r, i) {
    return Pa(J(t) ? !e : !0 === r ? !!(r = 0) : !i, function () {
      return J(t) ? t[~~(Math.random() * t.length)] : (r = r || 1e-5) && (i = r < 1 ? Math.pow(10, (r + "").length - 2) : 1) && Math.floor(Math.round((t - r / 2 + Math.random() * (e - t + 0.99 * r)) / r) * r * i) / i;
    });
  }
  function eb(e, r, t) {
  ...
  function sb(t, e, r) {
    ...
    if (!_) {
      if (("," === t.substr(-1) && (t = t.substr(0, t.length - 1)), Mt[t])) _ = Mt[t];
        ...
        } else (s = (+_[0] % 360) / 360), (o = _[1] / 100), (i = 2 * (u = _[2] / 100) - (n = u <= 0.5 ? u * (o + 1) : u + o - u * o)), 3 < _.length && (_[3] *= 1), (_[0] = rb(s + 1 / 3, i, n)), (_[1] = rb(s, i, n)), (_[2] = rb(s - 1 / 3, i, n));
  ...
  var B,
      ...
      return o(e) && (isNaN(e) || e in s)
        ? ((n = e.charAt(0)),
          ...
          "<" === n || ">" === n
            ...
            : i < 0
            ? (e in s || (s[e] = h), s[e])
            : ((n = parseFloat(e.charAt(i - 1) + e.substr(i + 1))), a && r && (n = (n / 100) * (J(r) ? r[0] : r).totalDuration()), 1 < i ? _parsePosition(t, e.substr(0, i - 1), r) + n : h + n))
        : null == e
        ? h
        : +e;
    },
    ...
    Dt =
      ...
      (T = {
        ...
        wake: function wake() {
          l &&
            (!n && u() && ((i = n = window), (a = i.document || {}), (ot.gsap = he), (i.gsapVersions || (i.gsapVersions = [])).push(he.version), M(h || i.GreenSockGlobals || (!i.gsap && i) || {}), (y = i.requestAnimationFrame)),
            m && T.sleep(),
            (g =
              y ||
              function (t) {
  ...
  function Dm(t) {
    return t < F ? E * t * t : t < 0.7272727272727273 ? E * Math.pow(t - 1.5 / 2.75, 2) + 0.75 : t < 0.9090909090909092 ? E * (t -= 2.25 / 2.75) * t + 0.9375 : E * Math.pow(t - 2.625 / 2.75, 2) + 0.984375;
  }
        ...
        return arguments.length
          ? (this._ps !== t &&
              ((this._ps = t)
                ...
                : (St(), (this._ts = this._rts), this.totalTime(this.parent && !this.parent.smoothChildTiming ? this.rawTime() : this._tTime || this._pTime, 1 === this.progress() && Math.abs(this._zTime) !== V && (this._tTime -= V)))),
            this)
          : this._ps;
      }),
          ...
          this._onUpdate && !e && Ot(this, "onUpdate", !0),
            ((v === m && this._tTime >= this.totalDuration()) || (!v && c)) &&
              ((f !== this._start && Math.abs(l) === Math.abs(this._ts)) ||
                this._lock ||
                ((!t && g) || !((v === m && 0 < this._ts) || (!v && this._ts < 0)) || ta(this, 1), e || (t < 0 && !c) || (!v && !c && m) || (Ot(this, v === m && 0 <= t ? "onComplete" : "onReverseComplete", !0), !this._prom || (v < m && 0 < this.timeScale()) || this._prom())));
        }
        return this;
      }),
            ...
            function _addComplexStringPropTween(t, e, r, i, n, a, s) {
              ...
              for (c.b = r, c.e = i, r += "", (_ = ~(i += "").indexOf("random(")) && (i = hb(i)), a && (a((p = [r, i]), t, e), (r = p[0]), (i = p[1])), u = r.match(it) || []; (o = it.exec(i)); )
                (l = o[0]),
                  ...
                  l !== u[g++] && ((d = parseFloat(u[g - 1]) || 0), (c._pt = { _next: c._pt, p: f || 1 === g ? f : ",", s: d, c: "=" === l.charAt(1) ? ea(d, l) - d : parseFloat(l) - d, m: h && h < 4 ? Math.round : 0 }), (m = it.lastIndex));
    ...
    Xt = function _initTween(e, r) {
      ...
      if ((!F || (M && v) || (v = "none"), (e._ease = Bt(v, L.ease)), (e._yEase = P ? Ft(Bt(!0 === P ? v : P, L.ease)) : 0), P && e._yoyo && !e._repeat && ((P = e._yEase), (e._yEase = e._ease), (e._ease = P)), (e._from = !F && !!g.runBackwards), !F || (M && !g.stagger))) {
        if (((c = (l = S[0] ? _(S[0]).harness : 0) && g[l.prop]), (i = oa(g, ut)), D && (ta(D.render(-1, !0)), (D._lazy = 0)), y))
          if ((ta((e._startAt = $t.set(S, ka({ data: "isStart", overwrite: !1, parent: z, immediateRender: !0, lazy: t(b), startAt: null, delay: 0, onUpdate: w, onUpdateParams: x, callbackScope: k, stagger: 0 }, y)))), r < 0 && !T && !C && e._startAt.render(-1, !0), T)) {
            if ((0 < r && !C && (e._startAt = 0), A && r <= 0)) return void (r && (e._zTime = r));
          } else !1 === C && (e._startAt = 0);
        else if (O && A)
          if (D) C || (e._startAt = 0);
          else if ((r && (T = !1), (a = ka({ overwrite: !1, data: "isFromStart", lazy: T && t(b), immediateRender: T, stagger: 0, parent: z }, i)), c && (a[l.prop] = c), ta((e._startAt = $t.set(S, a))), r < 0 && e._startAt.render(-1, !0), (e._zTime = r), T)) {
            if (!r) return;
    ...
    return (
        ...
        if (p) {
          if (c !== this._tTime || !t || r || (!this._initted && this._tTime) || (this._startAt && this._zTime < 0 != t < 0)) {
            if (((i = c), (l = this.timeline), this._repeat)) {
              ...
              if (((i = da(c % s)), c === _ ? ((a = this._repeat), (i = p)) : ((a = ~~(c / s)) && a === c / s && ((i = p), a--), p < i && (i = p)), (u = this._yoyo && 1 & a) && ((f = this._yEase), (i = p - i)), (o = gt(this._tTime, s)), i === d && !r && this._initted))
      ...
      (e.kill = function kill(t, e) {
        ...
        for (
          ...
          if (~d.indexOf(f[l])) for (u in ((n = p[l]), "all" === e ? ((i[l] = e), (s = n), (a = {})) : ((a = i[l] = i[l] || {}), (s = e)), s)) (h = n && n[u]) && (("kill" in h.d && !0 !== h.d.kill(u)) || sa(this, h, "_pt"), delete n[u]), "all" !== a && (a[u] = 1);
  ...
  function wd() {
    (function _windowExists() {
      ...
      window.document &&
      ((le = window), (fe = le.document), (de = fe.documentElement), (pe = sd("div") || { style: {} }), sd("div"), (Ve = je(Ve)), (Xe = Ve + "Origin"), (pe.style.cssText = "border-width:0;line-height:0;position:absolute;padding:0"), (me = !!je("perspective")), (_e = 1));
  }
  function xd(t) {
    var e,
        ...
        (!m && "%" !== h) || (!Fe[e] && !~e.indexOf("adius"))
          ? ((l[f ? "width" : "height"] = 100 + (c ? h : i)),
            ...
            (s = a._gsap) && m && s.width && f && s.time === Dt.time
              ? ca((u / s.width) * 100)
              : ((!m && "%" !== h) || (l.position = td(t, "position")), a === t && (l.position = "static"), a.appendChild(pe), (n = pe[p]), a.removeChild(pe), (l.position = "absolute"), f && m && (((s = _(a)).time = Dt.time), (s.width = a[p])), ca(c ? (n * u) / 100 : n && u ? (100 / n) * u : 0)))
  ...
  function Pd(t, e) {
    ...
    return s.svg && t.getAttribute("transform")
      ...
      : (u !== We ||
          ...
          t === de ||
          s.svg ||
          ((n = o.display), (o.display = "block"), ((r = t.parentNode) && t.offsetParent) || ((a = 1), (i = t.nextSibling), de.appendChild(t)), (u = Od(t)), n ? (o.display = n) : Bd(t, "display"), a && (i ? r.insertBefore(t, i) : r ? r.appendChild(t) : de.removeChild(t))),
  ...
  function $d(t, e, r, i, n) {
    var a,
      ...
      f = i + l + "deg";
    return (
      h && ("short" === (a = n.split("_")[1]) && (l %= u) !== l % 180 && (l += l < 0 ? u : -u), "cw" === a && l < 0 ? (l = ((l + 36e9) % u) - ~~(l / u) * u) : "ccw" === a && 0 < l && (l = ((l - 36e9) % u) - ~~(l / u) * u)),
    ...
    He = function _parseTransform(t, e) {
      ...
      return (
        ...
        m !== We &&
          ...
          (n = O = m[5]),
          6 === m.length
            ? ((s = Math.sqrt(T * T + b * b)), (o = Math.sqrt(x * x + w * w)), (u = T || b ? Le(b, T) * Be : 0), (f = w || x ? Le(w, x) * Be + u : 0) && (o *= Math.abs(Math.cos(f * Ie))), r.svg && ((i -= p - (p * T + c * w)), (n -= c - (p * b + c * x))))
            : ((E = m[6]),
              (z = m[7]),
              (A = m[8]),
              (D = m[9]),
              ...
              (a = m[14]),
              (h = (g = Le(E, S)) * Be),
              g && ((P = k * (v = Math.cos(-g)) + A * (y = Math.sin(-g))), (M = O * v + D * y), (C = E * v + S * y), (A = k * -y + A * v), (D = O * -y + D * v), (S = E * -y + S * v), (R = z * -y + R * v), (k = P), (O = M), (E = C)),
              (l = (g = Le(-w, S)) * Be),
        ...
        for (d in (_e || wd(), e))
          if ("autoRound" !== d && ((s = e[d]), !ft[d] || !Ub(d, e, r, i, t, n)))
            if (((l = typeof s), (f = Ge[d]), "function" === l && (l = typeof (s = s.call(r, i, t, n))), "string" === l && ~s.indexOf("random(") && (s = hb(s)), f)) f(this, t, d, s, r) && (T = 1);
              ...
              if (
                (x && d in x ? ((a = "function" == typeof x[d] ? x[d].call(r, i, t, n) : x[d]), o(a) && ~a.indexOf("random(") && (a = hb(a)), Ra(a + "") || (a += U.units[d] || Ra(Fd(t, d)) || ""), "=" === (a + "").charAt(1) && (a = Fd(t, d))) : (a = Fd(t, d)),
                (h = parseFloat(a)),
                (c = "string" === l && "=" === s.charAt(1) && s.substr(0, 2)) && (s = s.substr(2)),
                (u = parseFloat(s)),
                d in qe && ("autoAlpha" === d && (1 === h && "hidden" === Fd(t, "visibility") && u && (h = 0), Cd(this, w, "visibility", h ? "inherit" : "hidden", u ? "inherit" : "hidden", !u)), "scale" !== d && "transform" !== d && ~(d = qe[d]).indexOf(",") && (d = d.split(",")[0])),
                (m = d in Fe))
              )
                if ((g || (((v = t._gsap).renderTransform && !e.parseTransform) || He(t, e.parseTransform), (y = !1 !== e.smoothOrigin && v.smooth), ((g = this._pt = new oe(this._pt, w, Ve, 0, 1, v.renderTransform, v, 0, -1)).dep = 1)), "scale" === d))
            ...
            onReady: function (obj) {
              ...
              if ((self.options.animated && !self.options.strokeBased) || (!self.options.animated && color && !self.options.strokeBased)) {
                ...
                styleElement.textContent =
                  "#" + uniqid + " path, #" + uniqid + " line, #" + uniqid + " rect, #" + uniqid + " circle, #" + uniqid + " polyline { fill: " + color + "; stroke: " + color + "; " + animateStyle + (self.options.svgStyle ? self.options.svgStyle : "") + " } .finished path { fill-opacity: 1; }";
